...
function PlayerCard(props) {
  ...
  return (
    <Container width={width / 3 - 130 + 'px'}>
      <BgImageHolder>
        <BackgroundImage src="https://picsum.photos/200/300/?blur=2" />
      </BgImageHolder>
      <ContentHolder>
        <ProfileImage src="https://picsum.photos/seed/picsum/200/300" />
        <RealName className="text_cascading">
          Akhtar Zaman Akhtar Zaman Akhtar Zaman Akhtar Zaman
        </RealName>
        <PlayerName>@zeroshot01</PlayerName>
        <Assets>PUBG, COD</Assets>
      </ContentHolder>
    </Container>
  );
}
